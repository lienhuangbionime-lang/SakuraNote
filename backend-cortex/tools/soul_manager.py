...
# 核心靈魂檔案清單 (v7.1 Structure)
SOUL_FILES = {
    ".cursorrules": os.path.join(BASE_DIR, "backend-cortex", ".cursorrules"),
    ...
    "soul_manager.py": os.path.join(BASE_DIR, "backend-cortex", "tools", "soul_manager.py"),
}
