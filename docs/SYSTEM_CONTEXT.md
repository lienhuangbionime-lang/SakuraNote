...
## ☁️ CLOUD KNOWLEDGE BASE (ABSOLUTE TRUTH)
**Path**: `G:\我的雲端硬碟\Cortex`
**Directive**: All AI agents MUST search this location for the latest context, handover reports, and evolution logs. This is the **only** valid source for inter-agent memory.
